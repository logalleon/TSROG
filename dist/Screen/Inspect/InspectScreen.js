...
class InspectScreen extends Screen_1.Screen {
    ...
    inspectAdjacentTile(keyValue) {
        ...
        if (tile.isOccupied) {
            ...
            if (prop.canBePickedUp) {
                ...
                this.storeAndSwapInputMap(CommonHandlers_1.applyEscapeHandlerBinding(this, CommonHandlers_1.applyYesNoBinding(this, {}, () => {
                    ...
                    Game_1.default.instance.removeObjectFromMap(prop.pos);
        ...
        Game_1.default.instance.screenManager.activeScreen = Game_1.default.instance.screenManager.screens[Screen_1.ScreenNames.MAP];
        return [{ text }];
    }
    render() {
        this.highlightTiles();
        ...
        for (let x = pos.x - 1; x <= pos.x + 1; x++) {
            for (let y = pos.y - 1; y <= pos.y + 1; y++) {
                if (currentFloor.inBounds(floorWidth, floorHeight, new Vector_1.default(x, y)) &&
                    ...
                    const selector = Game_1.default.instance.screenManager.screens[Screen_1.ScreenNames.MAP].getTileId(y, x);
