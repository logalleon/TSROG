...
class InventoryItemScreen extends Screen_1.Screen {
    ...
    renderInventoryItems() {
        ...
        Game_1.default.instance.messenger.writeToPanel(Messenger_1.Panel.PANEL_1, this.renderTitle());
        Game_1.default.instance.messenger.writeToPanel(Messenger_1.Panel.PANEL_1, player[this.item].map((item, index) => {
            console.log(item);
            const message = {
    ...
    showEquipPrompt(itemReferenceAccessor) {
        ...
        this.storeAndSwapInputMap(CommonHandlers_1.applyEscapeHandlerBinding(this, CommonHandlers_1.applyYesNoBinding(this, {}, () => {
            ...
            if (Game_1.default.instance.player.attemptToEquip(accessor, itemReference.slot)) {
                Game_1.default.instance.messenger.writeToPanel(Messenger_1.Panel.PANEL_3, [
                    { text: `Successfully equipped ${item.name}.` }
                ]);
            }
            else {
                const equippedItem = Game_1.default.instance.player.equipped[itemReference.slot];
                Game_1.default.instance.messenger.writeToPanel(Messenger_1.Panel.PANEL_3, [
        ...
        Game_1.default.instance.messenger.clearPanel(Messenger_1.Panel.PANEL_3);
        Game_1.default.instance.messenger.writeToPanel(Messenger_1.Panel.PANEL_3, [message], true);
    }
