...
exports.MapScreenInputs = Map_1.MapScreenInputs;
class MapScreen extends Screen_1.Screen {
    constructor() {
        ...
        this.inputs = {
            [Map_1.MapScreenInputs.INVENTORY]: this.showScreen.bind(this, Screen_1.ScreenNames.INVENTORY),
            [Map_1.MapScreenInputs.AMULET]: this.showScreen.bind(this, Screen_1.ScreenNames.AMULET),
            [Map_1.MapScreenInputs.ARMOR]: this.showScreen.bind(this, Screen_1.ScreenNames.ARMOR),
            [Map_1.MapScreenInputs.FOOD]: this.showScreen.bind(this, Screen_1.ScreenNames.FOOD),
            [Map_1.MapScreenInputs.KEYS]: this.showScreen.bind(this, Screen_1.ScreenNames.KEYS),
            [Map_1.MapScreenInputs.POTIONS]: this.showScreen.bind(this, Screen_1.ScreenNames.POTIONS),
            [Map_1.MapScreenInputs.RING]: this.showScreen.bind(this, Screen_1.ScreenNames.RING),
            [Map_1.MapScreenInputs.SCROLL]: this.showScreen.bind(this, Screen_1.ScreenNames.SCROLL),
            [Map_1.MapScreenInputs.WEAPONS]: this.showScreen.bind(this, Screen_1.ScreenNames.WEAPON),
            [Map_1.MapScreenInputs.COMMANDS]: this.showScreen.bind(this, Screen_1.ScreenNames.COMMANDS),
            [Map_1.MapScreenInputs.EQUIPMENT]: this.showScreen.bind(this, Screen_1.ScreenNames.EQUIPMENT),
            [Map_1.MapScreenInputs.MESSAGES]: this.showScreen.bind(this, Screen_1.ScreenNames.MESSAGES),
            [Map_1.MapScreenInputs.HELP]: this.showScreen.bind(this, Screen_1.ScreenNames.HELP),
            [Map_1.MapScreenInputs.MOVE_UP]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_LEFT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_DOWN]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_RIGHT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_UP_LEFT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_UP_RIGHT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_DOWN_LEFT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.MOVE_DOWN_RIGHT]: this.attemptPlayerMovement.bind(this),
            [Map_1.MapScreenInputs.DESCEND]: this.attemptDescend,
            [Map_1.MapScreenInputs.WAIT]: this.playerWait,
            [Map_1.MapScreenInputs.INSPECT]: this.showScreen.bind(this, Screen_1.ScreenNames.INSPECT),
            [Map_1.MapScreenInputs.SKILLS]: this.showScreen.bind(this, Screen_1.ScreenNames.SKILLS)
        };
    }
    render() {
    ...
    attemptPlayerMovement(keyValue) {
        ...
        if (player.canMove && currentFloor.inBounds(currentFloor.floorWidth, currentFloor.floorHeight, nextPos)) {
            ...
            if (isPassible && !isOccupied) {
                ...
                Game_1.default.instance.entityManager.updatePlayerPos(player, nextPos);
    ...
    showScreen(screen) {
        Game_1.default.instance.screenManager.activeScreen = Game_1.default.instance.screenManager.screens[screen];
    }
    attemptDescend() {
